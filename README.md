...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gasgztk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gasgztk.containers.anotherwebservice.com/
...
```
git clone git@github.com:Jzombi-le-codeur/container-gasgztk.git
cd container-gasgztk
```
...
```
docker attach container-gasgztk
```
